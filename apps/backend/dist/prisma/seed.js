...
async function main() {
    ...
    const lead4 = await prisma.lead.create({
        data: {
            status: client_1.LeadStatus.DISQUALIFIED,
    ...
    const opportunities = [
        ...
        },
        {
            ...
            stage: client_1.OpportunityStage.PROSPECTING,
        ...
        },
        {
            ...
            stage: client_1.OpportunityStage.CLOSED_WON,
        ...
        },
        {
            ...
            stage: client_1.OpportunityStage.CLOSED_LOST,
